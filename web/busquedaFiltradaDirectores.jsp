<%-- 
    Document   : busquedaFiltradaDirectores
    Created on : 25-nov-2020, 11:56:17
    Author     : PC3
--%>
...
<html lang="en">
    ...
    <%
        ...
        String tabla = (String) contexto.getAttribute("tablaDirectores");
        String errores = "";
        errores = (String) getServletContext().getAttribute("errorBusquedaDirectores");
            ...
            <div class="container-fluid mt-5 pt-5">
                <div class="row my-3">
                    <div class="col-2-lg col-md-2 col-sm-12">
                        <form action="ServletBusquedaDirectores" method="post" class="input-group">
                            <label class="lead">Filtrar por director</label>
                    </div>
