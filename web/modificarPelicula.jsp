<%-- 
    ...
    Created on : 26-nov-2020, 14:32:04
    Author     : Ramos-PC
--%>
...
<html lang="en">
    ...
    <body><%
        ...
        String exito = "";
        String errores = "";
        exito = (String) getServletContext().getAttribute("exitoModificando");
        errores = (String) getServletContext().getAttribute("erroresModificacion");
            ...
            <div class="container-fluid mt-5 pt-5">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12 mt-5">
                        <h2>Modificar película</h2><%if (exito != null && !exito.isEmpty()) {%>                       
                        <p class="lead font-weight-bold text-center"><%=exito%><img class="imf-fluid" width="30px" src="images/icons8-casilla-de-verificación-2-100.png" ></p>
                            <%exito = "";
                                    contexto.setAttribute("exitoModificando", exito);
                                }%>
                        ...
                        <p class="lead font-weight-bold text-center"><%=errores%><img class="imf-fluid" width="30px" src="images/icons8-cerrar-ventana-48.png" ></p>
                            <%errores = "";
                                    contexto.setAttribute("erroresModificacion", errores);
                                }%>

                        <!-- FORM -->
                        <form action="ServletModificacion" method="POST">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Nuevo título</label>
                                <input
                                    type="text"
                                    class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="directorSeleccionado">
                                    <%for (Director lista : listaDirectores) {%>
                            ...
                            <input
                                type="submit"
                                class="form-control btn btn-outline-warning font-weight-bold"
                                value="Modificar"
                                />
                        </form>
                        <!-- FORM -->
